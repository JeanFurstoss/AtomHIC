...
int main(int argc, char *argv[])
{
	...
	Properties.push_back("GMM_TOL_LKH_EM 1e-4");
	...
	Properties.push_back("GMM_NB_INIT 5");
	Properties.push_back("GMM_INIT_METHOD KMEANSPP");
	...
	KMProp.push_back("KMEANS_NB_INIT 1");
